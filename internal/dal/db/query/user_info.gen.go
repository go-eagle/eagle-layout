...
func newUserInfoModel(db *gorm.DB, opts ...gen.DOOption) userInfoModel {
	...
	_userInfoModel.Gender = field.NewBool(tableName, "gender")
	_userInfoModel.Birthday = field.NewString(tableName, "birthday")
	_userInfoModel.Phone = field.NewInt64(tableName, "phone")
	_userInfoModel.Email = field.NewString(tableName, "email")
	_userInfoModel.Bio = field.NewString(tableName, "bio")
	_userInfoModel.CreatedAt = field.NewInt32(tableName, "created_at")
	_userInfoModel.UpdatedAt = field.NewInt32(tableName, "updated_at")
	_userInfoModel.LoginAt = field.NewInt32(tableName, "login_at")
	_userInfoModel.Status = field.NewBool(tableName, "status")
...
func (u *userInfoModel) updateTableName(table string) *userInfoModel {
	...
	u.LoginAt = field.NewInt32(table, "login_at")
